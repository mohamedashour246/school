    ...
    <form method="post" action="{{ route('attendance.store') }}">
        ...
        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
            ...
            <tr>
                ...
                <th class="alert-success">{{ trans('main_trans.student_name') }}</th>
                <th class="alert-success">{{ trans('main_trans.Email') }}</th>
                <th class="alert-success">{{ trans('main_trans.Gender') }}</th>
                <th class="alert-success">{{ trans('main_trans.Grade') }}</th>
                <th class="alert-success">{{ trans('main_trans.classrooms') }}</th>
        ...
        <P>
            <button class="btn btn-success" type="submit">{{ trans('main_trans.submit') }}</button>
        </P>
    </form><br>
    <!-- row closed -->
@endsection
