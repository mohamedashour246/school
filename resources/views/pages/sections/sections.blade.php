                                                            ...
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                @foreach ($Grade->Sections as $list_Sections)
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ $list_Sections->class->name_class }}
                                                                        </td>
                                                                        <td>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <form
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <label for="inputName"
                                                                                                   class="control-label">{{ trans('main_trans.Name_Grade') }}</label>
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <label for="inputName"
                                                                                                   class="control-label">{{ trans('main_trans.Name_Class') }}</label>
                                                                                            <select name="Class_id"
                                                                                                    class="custom-select">
                                                                                                <option
                                                                                                    value="{{ $list_Sections->class->id }}">
                                                                                                    {{ $list_Sections->class->name_class }}
                                                                                                </option>
                                                                                            </select>
                                                                                        </div>
                                                                                        <br>
                                                                                        ...
                                                                                        <div class="col">
                                                                                            <div class="form-check">
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    for="exampleCheck1">{{ trans('main_trans.Status') }}</label>
                                                                                            </div>
                                                                                        </div>

                                                                                        <div class="col">
                                                                                            <label for="inputName" style="margin-top:30px;"
                                                                                                   class="control-label">{{ trans('main_trans.Name_Teacher') }}</label>
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <input type="text" name="Name_Section_Ar" class="form-control"
                                                       placeholder="{{ trans('main_trans.Section_name_ar') }}">
                                            </div>

                                            <div class="col">
                                                <input type="text" name="Name_Section_En" class="form-control"
                                                       placeholder="{{ trans('main_trans.Section_name_en') }}">
                                            </div>
