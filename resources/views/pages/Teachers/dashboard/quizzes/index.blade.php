                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('quizes.edit',$quizze->id)}}"
                                                    ...
                                                    <a href="{{route('quizes.show',$quizze->id)}}"
                                            ...
                                            <div class="modal fade" id="delete_exam{{$quizze->id}}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <form action="{{route('quizes.destroy','test')}}" method="post">
                                                        {{method_field('delete')}}
                                                        {{csrf_field()}}
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <p> {{ trans('main_trans.Warning') }} {{$quizze->name}}</p>
