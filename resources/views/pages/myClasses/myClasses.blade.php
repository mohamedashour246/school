...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        <div class="card-body">
            ...
            <button type="button" data-toggle="modal"  class="button x-small" id="btn_delete_all">
                {{ trans('my_Classes_trans.delete_checkbox') }}
            </button>
            <br><br>
                <form action="{{ route('Filter_Classes') }}" method="POST">
                    {{ csrf_field() }}
                    <select style="margin-bottom:30px;" class="selectpicker" data-style="btn-info" name="Grade_id" required
                ...
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th> # </th>
                            <th>{{ trans('my_Classes_trans.class_name_ar') }}</th>
                    ...
                    <tbody>
                        ...
                        @foreach ($List_Classes as $My_Class)
                            <tr>
                                <td> <input name="select_all" value="{{$My_Class->id}}" class="box1" type="checkbox" > </td>
                                <td>{{ $My_Class->id }}</td>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form action="{{route('Classrooms.update','test')}}" method="post">
                                                ...
                                                <div class="row">
                                                    <div class="col">
                                                        <label for="Name"
                                                               class="mr-sm-2">{{ trans('my_Classes_trans.class_name_ar') }}
                                                            :</label>
                ...
                <form class=" row mb-30" action="{{ route('Classrooms.store') }}" method="POST">
                    ...
                    <div class="card-body">
                        <div class="repeater">
                            ...
                            <div class="row mt-20">
                                <div class="col-12">
                                    <input style="margin-bottom:20px;" class="button" data-repeater-create type="button" value="{{ trans('my_Classes_trans.add_row') }}"/>
                                </div>
