                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="home-02" role="tabpanel"
                                    ...
                                    <table class="table table-striped table-hover" style="text-align:center">
                                        <tbody>
                                        <tr>
                                            <th scope="row">{{trans('main_trans.student_name')}}</th>
                                            <td>{{ $Student->name }}</td>
                                ...
                                <div class="tab-pane fade" id="profile-02" role="tabpanel"
                                    ...
                                    <div class="card card-statistics">
                                            ...
                                            <form method="post" action="{{route('Upload_attachment')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label
                                                                for="academic_year">{{trans('main_trans.Attachments')}}
                                        ...
                                        <table class="table center-aligned-table mb-0 table table-hover"
                                            ...
                                            <tbody>
{{--                                            {{url('Download_attachment')}}/{{ $attachment->imageable->name }}/{{$attachment->filename}}--}}
