@if($currentStep != 1)
    <div style="display: none" class="row setup-content" id="step-1" xmlns:wire="http://www.w3.org/1999/xhtml">
        @endif
        <div class="col-xs-12">
            <div class="col-md-12">
                <br>
                ...
                <div class="form-row">
                    ...
                    <div class="col">
                        <label for="title">{{trans('main_trans.National_ID_Father')}}</label>
                    ...
                    <div class="col">
                        <label for="title">{{trans('main_trans.Passport_ID_Father')}}</label>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputCity">{{trans('main_trans.Nationality_Father_id')}}</label>
                    ...
                    <div class="form-group col">
                        <label for="inputZip">{{trans('main_trans.Religion_Father_id')}}</label>
