        ...
        <div class="stepwizard">
            <div class="stepwizard-row setup-panel">
                <div class="stepwizard-step">
                    ...
                    <p>{{ trans('main_trans.Father_info') }}</p>
                </div>
                <div class="stepwizard-step">
                    <a href="#step-2" type="button"
                       class="btn btn-circle {{ $currentStep != 2 ? 'btn-default' : 'btn-success' }}">2</a>
                    <p>{{ trans('main_trans.Mother_info') }}</p>
                </div>
                <div class="stepwizard-step">
                    <a href="#step-3" type="button"
                       class="btn btn-circle {{ $currentStep != 3 ? 'btn-default' : 'btn-success' }}"
                       disabled="disabled">3</a>
                    <p>{{ trans('main_trans.check_info') }}</p>
                </div>
            </div>
        </div>
            ...
            <div style="display: none" class="row setup-content" id="step-3">
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <label style="color:red"> {{ trans('main_trans.Attachment')}} </label>
                        ...
                        @if($updateMode)
                            ...
                            <button class="btn btn-success btn-sm btn-lg pull-right" wire:click="submitForm_edit"
                                    type="button">{{ trans('main_trans.Finish') }}
                            </button>
                        @else
